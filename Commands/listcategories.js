...
module.exports = {
	...
	async execute(message, args) {
		...
		categoryList.map(val => listEmbed.fields.push({name: val.categoryTitle, value: globalFunctions.makeMsgLink(val.messageID[message.guild.id], categoryID, message.guild.id)}))
