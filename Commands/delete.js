...
module.exports = {
	...
	execute(message, args) {
		...
		if (message.member.roles.cache.find(role => role.name != "Discord Staff") && message.member.roles.cache.find(role => role.name != "Discord Management")) return message.channel.send("You don't have permission to use this command!")
